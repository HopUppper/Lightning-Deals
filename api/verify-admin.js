// Vercel Serverless Wrapper for LightningDeals /api/verify-admin.js
const netlifyHandler = require('../functions/verify-admin.js').handler;
...
module.exports = async (req, res) => {
    ...
    try {
        ...
        console.error("Vercel wrapper failed for verify-admin:", err);
