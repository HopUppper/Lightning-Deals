// Vercel Serverless Wrapper for LightningDeals /api/auth-reset.js
const netlifyHandler = require('../functions/auth-reset.js').handler;
...
module.exports = async (req, res) => {
    ...
    // Apply Rate Limiting
    const rateLimitPassed = await applyRateLimit('password-reset', req, res);
    ...
    try {
        ...
        console.error("Vercel wrapper failed for auth-reset:", err);
