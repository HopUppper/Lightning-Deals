// Vercel Serverless Wrapper for LightningDeals /api/razorpay-webhook.js
const netlifyHandler = require('../functions/razorpay-webhook.js').handler;
...
module.exports = async (req, res) => {
    ...
    try {
        ...
        console.error("Vercel wrapper failed for razorpay-webhook:", err);
