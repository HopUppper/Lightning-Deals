// Vercel Serverless Wrapper for LightningDeals /api/trigger-notification.js
const netlifyHandler = require('../functions/trigger-notification.js').handler;
...
module.exports = async (req, res) => {
    ...
    try {
        ...
        console.error("Vercel wrapper failed for trigger-notification:", err);
